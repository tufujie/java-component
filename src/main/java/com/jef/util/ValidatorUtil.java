...
public class ValidatorUtil {
	...
	/** 手机 */
	private static final String V_MOBILE = "^(13|14|15|18)[0-9]{9}$";
	...
	/** 字母 + 数字 */
	private static final String V_LETTER_Z_INDEX = "^[A-Za-z0-9]+$";
    /* 字母 + 数字 + - */
    private static final String V_LETTER_Z_SLASH = "^[A-Za-z0-9-]+$";
	...
	/** 科学计数法 */
	private static String V_eNum = "^((-?\\d+.?\\d*)[Ee]{1}(-?\\d+))$";
	 ...
	 * @return
     */
	public static boolean isENum(String value){//判断输入字符串是否为科学计数法
		return match(V_eNum, value);
	}
	 ...
	 * @return 如果是符合格式的字符串,返回 <b>true </b>,否则为 <b>false </b>
	 */
	public static boolean isLetterZIndex(String value) {
		return match(V_LETTER_Z_INDEX, value);
	}
     ...
     * @return 如果是符合格式的字符串，返回 <b>true</b>,否则为 <b>false</b>
     */
    public static boolean isLetterZSlash(String value){
        return match(V_LETTER_Z_SLASH, value);
    }
     ...
     * @return 如果是符合格式的字符串,返回 <b>true </b>,否则为 <b>false </b>
     */
    public static boolean isEnglishOrNumber(String value) {
        return match(V_LETTER_Z_INDEX, value);
    }
